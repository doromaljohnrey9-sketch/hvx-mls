...
interface ExamSetsTableProps<TData, TValue> {
...
export function ExamSetsTable<TData, TValue>({
  columns,
  data,
  isLoading,
  pagination,
}: ExamSetsTableProps<TData, TValue>) {
  const t = useTranslations("ExamSets.table");
            ...
            {isLoading ? (
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="h-24 text-center">
                  <span className="text-muted-foreground font-medium">{t("noExamSets")}</span>
                </TableCell>
              </TableRow>
            )}
          </TableBody>
