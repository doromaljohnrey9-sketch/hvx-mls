# HVX — Past-Exam Explainer Video Learning System · PRD

> **HVX — HEMS Video eXplainer** · HEMS sub-module

| Item | Details |
|---|---|
| Document No. | `G-HEMS-HVX-PRD-20260602-001` |
| Author | CEO |
| Date | 2026-06-02 |
| Stakeholders | HVX dev team / Content operations / Branch admins / Teachers / Students |
...
This is a product requirements document for migrating the school-by-school past-exam explainer videos—currently managed as MyBox-style folders—into a learning system (HVX) within HEMS.
...
- **Product name**: HVX (HEMS Video eXplainer) — HEMS past-exam explainer system
...
| Dev team | HVX developers | Build, deploy, operate features |
...
**Student**
1. Open HVX → sign up (name, branch, school, grade, class/assigned teacher).
...
- The core of the HVX MVP is not a "video upload system" but **"a system where approved students quickly find and watch the school-specific past-exam explainer videos they need."**
